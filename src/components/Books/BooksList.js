      ...
      <tr>
        ...
        <td>
          <Link
            ...
            to={`/portal/bookview/${bookdata.id}`}
          >
            <FontAwesomeIcon icon={faEye} color="#810CA8" />
          </Link>
          {logindata.isLibrarianVisible ? null : (
            <Link
              className="btn btn-danger btn-sm me-1"
              to={`/portal/borrowbook/${bookdata.id}`}
            >
              Borrow
            </Link>
          )}
          {logindata.isLibrarianVisible ? null : (
            <Link
              ...
              to={`/portal/returnbook/${bookdata.id}`}
            >
              Return
            </Link>
          )}
          {logindata.isLibrarianVisible ? (
            <Link
              className="btn  btn-sm me-1"
              to={`/portal/editbook/${bookdata.id}`}
            >
