  ...
  const myFormik = useFormik({
    ...
    onSubmit: async (values) => {
      try {
        setLoading(true);
        await axios.post(
          `https://638dfe2b4190defdb753283c.mockapi.io/books`,
          values
        );
      } catch (error) {
        console.log(error);
        ...
        <div className="row mt-4 ps-5">
          <div className="col-lg-5  mt-5 m-auto">
            ...
            <input
              type="text"
              className={`form-control ${
                myFormik.touched.book_count && myFormik.errors.book_count
                  ? "is-invalid"
                  : "is-valid"
              }`}
            ...
            <input
              type="text"
              className={`form-control ${
                myFormik.touched.author && myFormik.errors.author
                  ? "is-invalid"
                  : "is-valid"
              }`}
